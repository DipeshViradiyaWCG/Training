...
const {user_cart_get, user_addtocart_get, user_deletecart_get} = require("../controllers/cart_controllers/user_cart")
...
router.get('/add-to-cart/:id', isLogin, user_addtocart_get);
router.get('/delete-cart/:id', isLogin, user_deletecart_get);

router.get('/show-cart', isLogin, user_cart_get);
